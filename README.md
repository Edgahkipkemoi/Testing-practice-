...
**[Testing Practice]**  In this project I setup the Testing Practice project.
...
```
$ git clone https://github.com/Edgahkipkemoi/Testing-practice-.git
```
...
Feel free to check the [issues page](https://github.com/Edgahkipkemoi/Testing-practice-/issues).
